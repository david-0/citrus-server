...
import {OrderCustomerModelWrapper} from "./controllers/CustomerOrderModelWrapper";
...
import {VendorOrderModelWrapper} from "./controllers/VendorOrderModelWrapper";
...
//    this.app.use(getAuthenticationRoute(this.jwtConfig));
    ...
    this.app.use("/api/order", GenericRouter.all(new GenericController(new OrderCustomerModelWrapper())));
    ...
    this.app.use("/api/shipment", GenericRouter.all(new GenericController(new VendorOrderModelWrapper())));
